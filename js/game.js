...
const levels = [
  {
    ...
    lives: true,
    portrait: 'disciple',
    intro: `You are a young disciple in Jerusalem. Saul’s men are searching street by street. The house church is no longer safe.<br><br>You must sneak through the alleys, hide behind market stalls, and slip out the city gate before they catch you. A clay water jar sits on a stone along the left wall — press <strong>E</strong> (or Pick up) to grab it, then <strong>E</strong> again to place it. The jar is optional; the gate is the way out.<br><br><strong>Three lives. No verses needed. Just timing and quick feet.</strong>`,
    type: "stealth"
  },
  {
    id: 2,
